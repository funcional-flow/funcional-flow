        ...
        <div className="relative z-10 mx-auto w-full">
          ...
          <SectionTween horizontal={true} initialNum={-100} delay={1.5}>
            <p className="mb-8 text-lg text-white/75">
              Acompanhamento personalizado para desenvolver capacidades físicas
              e construir um corpo atlético, seja qual for o seu nível de
              treinamento:{" "}
        ...
        <div className="relative z-10">
            ...
            <SpringCustom delayNum={1.75}>
              <div className="flex flex-col gap-3 pb-5">
                <button
                  ...
                  className="group from-yellow3 text-purple4 shadow-yellow3/30 hover:shadow-yellow3/50 flex items-center justify-center gap-2 rounded-xl bg-linear-to-r to-yellow-500 px-6 py-4 text-[15px] font-bold shadow-xl transition active:scale-[0.98] md:text-lg"
                >
                  PARTICIPE AGORA
          ...
          <div className="flex justify-center gap-2 md:gap-7 md:pt-2">
            <SpringCustom delayNum={2}>
              <span className="bg-purple3/10 rounded-full border border-white/15 px-3.5 pt-1.5 pb-1 text-xs font-medium backdrop-blur-sm md:text-base">
