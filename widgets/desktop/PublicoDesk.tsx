...
import CardPublicoDesk from "@/components/desktop/CardPublicoDesk";

export default function PublicoDesk() {
  return (
    <ImageBackground
      imageUrl="/fundo.jpeg"
      svh="100"
    ...
    >
      ...
      <div className="relative flex flex-col py-12 xl:py-40">
        <TituloSessao escuro={false} className="mb-3">
          <BottomUpLetters triggerOnView={true}>
            pra quem é a consultoria
          </BottomUpLetters>
        </TituloSessao>
        <h2 className="mx-9 pb-6 text-center text-4xl font-bold lg:pb-15 xl:text-5xl">
        ...
        <div className="z-20 mx-auto flex w-xl flex-col gap-5 px-6">
