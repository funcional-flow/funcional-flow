  ...
  return (
    <div className="relative z-10">
      ...
      <div className="mx-auto mt-8 max-w-md px-6">
        <button className="group from-yellow3 text-purple4 shadow-yellow3/20 hover:shadow-yellow3/50 flex w-full items-center justify-center gap-2 rounded-xl bg-linear-to-r to-yellow-600 px-6 py-4 text-[15px] font-bold shadow-xl transition active:scale-[0.98]">
